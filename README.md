...
Python bindings for American Whitewater's GraphQL endpoint.
...
```
    ...
    ├── setup.py           <- Setup script for the library (wh2o)
    ...
    │   ├── wh2o-graphql.aprx <- ArcGIS Pro project.    
    │   └── wh2o-graphql.tbx  <- ArcGIS Pro toolbox associated with the project.
    ...
    └── src                <- Source code for use in this project.
        └── wh2o <- Library containing the bulk of code used in this 
                                                  project. 
```
